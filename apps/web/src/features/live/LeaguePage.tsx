      ...
      {isPending ? (
        ...
        <>
          ...
          <p className="mb-3 text-xs text-muted">
            Page {data.standings.page} · Tap a team to view its lineup
          </p>
                ...
                return (
                  <li key={row.entry}>
                    <Link
                      ...
                      aria-label={`View ${row.entry_name}, ${row.player_name}'s team`}
                      className={`grid min-h-14 grid-cols-[2.5rem_minmax(0,1fr)_3rem_3.5rem] items-center gap-2 px-3 py-2.5 transition-colors hover:bg-brand-soft focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-brand active:bg-brand-soft ${
                        isMe ? 'bg-brand-soft' : ''
                      }`}
                    >
